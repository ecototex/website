    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="font-miluno text-black text-3xl md:text-6xl mb-6 md:mb-8 tracking-wide leading-tight">
              SUSTAINABILITY <br/>
              <span className="text-leafGreen font-milonga text-2xl md:text-5xl">meets style.</span>
            </h2>
            
            <div className="space-y-4 md:space-y-6 text-deepSlate/80 text-sm md:text-lg leading-relaxed font-inter">
              <p>
              ...
              <div className="h-1 w-16 md:w-20 bg-leafGreen/50 rounded-full" />
            </div>
          </motion.div>
          ...
          <div className="space-y-4 md:space-y-6">
            <motion.div 
              className="bg-white/60 backdrop-blur-md p-5 md:p-8 rounded-3xl border border-white shadow-lg shadow-sageTint/20"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="font-miluno text-base md:text-xl text-deepSlate mb-2 md:mb-3">CRAFTED FOR LIFE</h3>
              <p className="text-deepSlate/70 font-inter text-xs md:text-base">
            ...
            <motion.div 
              className="bg-deepSlate p-5 md:p-8 rounded-3xl shadow-xl text-white relative overflow-hidden"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h3 className="font-miluno text-base md:text-xl text-leafGreen mb-2 md:mb-3">BEYOND BAGS</h3>
              <p className="text-white/80 font-inter text-xs md:text-base">
